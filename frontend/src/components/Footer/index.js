...
export default class Footer extends React.Component {
  ...
  return (
    ...
    <Navbar className="justify-content-center main" style={divPadding} sticky="bottom">
      ...
      <Col>
        <ul className="list-unstyled">
          <Nav.Link href="https://www.facebook.com/datasciencegt/" target="_blank"><FaFacebookF />Facebook</Nav.Link>
          <Nav.Link href="https://www.instagram.com/datasciencegt/" target="_blank" ><FaInstagram />Instagram</Nav.Link>
        </ul>
      </Col>
      {/*column 3*/}
      <Col>
