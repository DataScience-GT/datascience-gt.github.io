...
class LoginComponent extends React.Component {
  ...
  render() {
    if (this.context) {
      return (
        <Button href="" onClick={this.SignOut} variant="outline-light">
          Sign Out
        </Button>
      );
    } else {
  ...
  render() {
    if (this.context) {
      ...
      return (
        ...
        <Button href={'https://docs.google.com/forms/d/e/1FAIpQLSfv3_12vdyWsy_Lz9u3DCarO1Mw_HxIsF3hzm-92KOVU_otwQ/viewform?usp=sf_link'} variant="outline-light">
          Sign Up
        </Button>
      ...
      <div className="main">
        ...
        <Navbar sticky="top" expand="md">
          <Navbar.Brand href={ROUTES.LANDING}>
            <img src={DSGTLogo} width="35" height="35" alt="DSGT icon" />
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="responsive-navbar-nav" />
          <Navbar.Collapse>
