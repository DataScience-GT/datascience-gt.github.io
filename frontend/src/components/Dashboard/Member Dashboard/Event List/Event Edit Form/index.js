            ...
            <Form>
                ...
                <div className="event-button-container">
                    <Button disabled={!isEventOwnerContext} 
                            onClick={() => this.props.handleSubmit(this.props.event.id, this.state.name, this.state.desc, this.state.XP, this.state.date, this.state.meetingLink, this.state.resourceLink, this.state.type)} className="rsvp-button" variant="outline-success">Save</Button>
                    <Button disabled={!isEventOwnerContext} 
